...
- [KDE Linux](https://linux.kde.org/) - KDE’s official Alpha-stage immutable, image-based reference operating system, built from Arch Linux packages and featuring Plasma, Flatpak-first apps, atomic updates, and rollback support.
